...
//! Entry point for C1pzoApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &C1pzoApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for C1pzoGUI tests.
void AppTests::guiTests(C1pzoGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &C1pzoGUI::consoleShown, this, &AppTests::consoleTests);
