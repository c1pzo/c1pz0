...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<C1pzoAmountField*>("payAmount")->setValue(amount);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_c1pzo-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_c1pzo-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_c1pzo-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = C1pzoUnits::formatWithUnit(unit, balance, false, C1pzoUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    C1pzoAmountField* amountInput = receiveCoinsDialog.findChild<C1pzoAmountField*>("reqAmount");
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_c1pzo-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI(m_node);
