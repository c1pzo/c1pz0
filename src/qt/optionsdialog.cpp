    ...
    mapper(nullptr)
{
    ...
    ui->c1pzoAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->c1pzoAtStartup);
    ...
    ui->c1pzoAtStartup->setToolTip(ui->c1pzoAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->c1pzoAtStartup->setText(ui->c1pzoAtStartup->text().arg(PACKAGE_NAME));

    ui->openC1pzoConfButton->setToolTip(ui->openC1pzoConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new C1pzoUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->c1pzoAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openC1pzoConfButton_clicked()
{
