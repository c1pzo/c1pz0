...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, C1pzoGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &C1pzoGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &C1pzoGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &C1pzoGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &C1pzoGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &C1pzoGUI::updateWalletStatus);
    connect(gui, &C1pzoGUI::setPrivacy, walletView, &WalletView::setPrivacy);
