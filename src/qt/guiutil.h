...
#ifndef C1PZO_QT_GUIUTIL_H
#define C1PZO_QT_GUIUTIL_H
...
/** Utility functions used by the C1pzo Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "c1pzo:" URI into recipient object, return true on successful parsing
