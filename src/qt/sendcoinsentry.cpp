    ...
    platformStyle(_platformStyle)
{
    ...
    // normal c1pzo address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying c1pzo address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &C1pzoAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
