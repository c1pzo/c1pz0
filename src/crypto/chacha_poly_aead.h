...
#ifndef C1PZO_CRYPTO_CHACHA_POLY_AEAD_H
#define C1PZO_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@c1pzo.
 *
 * ChaCha20 is a stream cipher designed by Daniel Bernstein and described in
 * <ref>[https://cr.yp.to/chacha/chacha-20200128.pdf ChaCha20]</ref>. It operates
 ...
 *
 * The chacha20-poly1305@c1pzo combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@c1pzo cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@c1pzo are relatively fast in
...
#endif // C1PZO_CRYPTO_CHACHA_POLY_AEAD_H
