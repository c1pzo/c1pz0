...
public:
    CMainParams() {
        ...
        consensus.BIP16Exception = uint256S("0000000068b310d27d662c1cb24337694d93c8969a86326e9481f397e3e90358");
        consensus.BIP34Height = 227931;
        consensus.BIP34Hash = uint256S("0000000068b310d27d662c1cb24337694d93c8969a86326e9481f397e3e90358");
        consensus.BIP65Height = 388381; // 0000000068b310d27d662c1cb24337694d93c8969a86326e9481f397e3e90358
        consensus.BIP66Height = 363725; // 0000000068b310d27d662c1cb24337694d93c8969a86326e9481f397e3e90358
        ...
        genesis = CreateGenesisBlock(1613488832, 860771, 504365040, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000005fa8be0fa1c567c8ad97770fa87c762d2368bd342939f52c7abc9e79e7b"));
        assert(genesis.hashMerkleRoot == uint256S("68ad67db7ec2e01a14ead8e085ab723b065489fc0778bd69a388017a6f79c918"));
        ...
        //vSeeds.emplace_back("seed.c1pzo.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        //vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        //vSeeds.emplace_back("dnsseed.c1pzo.dashjr.org"); // Luke Dashjr
        //vSeeds.emplace_back("seed.c1pzostats.com"); // Christian Decker, supports x1 - xf
        //vSeeds.emplace_back("seed.c1pzo.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        //vSeeds.emplace_back("seed.pzo.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
        //vSeeds.emplace_back("seed.c1pzo.sprovoost.nl"); // Sjors Provoost
        //vSeeds.emplace_back("dnsseed.emzy.de"); // Stephan Oeste
        //vSeeds.emplace_back("seed.c1pzo.wiz.biz"); // Jason Maurice
...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Hash = uint256S("0000000068b310d27d662c1cb24337694d93c8969a86326e9481f397e3e90358");
        consensus.BIP65Height = 581885; // 0000000068b310d27d662c1cb24337694d93c8969a86326e9481f397e3e90358
        consensus.BIP66Height = 330776; // 0000000068b310d27d662c1cb24337694d93c8969a86326e9481f397e3e90358
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000005fa8be0fa1c567c8ad97770fa87c762d2368bd342939f52c7abc9e79e7b"));
        assert(genesis.hashMerkleRoot == uint256S("0x68ad67db7ec2e01a14ead8e085ab723b065489fc0778bd69a388017a6f79c918"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.c1pzo.jonasschnelli.ch");
        //vSeeds.emplace_back("seed.tpzo.petertodd.org");
        //vSeeds.emplace_back("seed.testnet.c1pzo.sprovoost.nl");
