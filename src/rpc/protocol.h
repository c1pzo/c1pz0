...
#ifndef C1PZO_RPC_PROTOCOL_H
#define C1PZO_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in c1pzod
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< C1pzo is not connected
