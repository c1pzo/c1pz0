 ...
 */
#ifndef C1PZO_UTIL_SYSTEM_H
#define C1PZO_UTIL_SYSTEM_H
...
extern const char * const C1PZO_CONF_FILENAME;
extern const char * const C1PZO_SETTINGS_FILENAME;
