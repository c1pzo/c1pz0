...
#ifndef C1PZO_SCRIPT_STANDARD_H
#define C1PZO_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a c1pzo address
 */
...
/**
 * Generate a C1pzo scriptPubKey for the given CTxDestination. Returns a P2PKH
