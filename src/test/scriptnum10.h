...
#ifndef C1PZO_TEST_SCRIPTNUM10_H
#define C1PZO_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from C1pzo Core 0.10.0, for cross-comparison.
 */
public:
