...
#ifndef C1PZO_WALLET_SCRIPTPUBKEYMAN_H
#define C1PZO_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The C1pzo Core wallet was originally a collection of unrelated private
...
#endif // C1PZO_WALLET_SCRIPTPUBKEYMAN_H
