...
#ifndef C1PZO_WALLET_WALLETUTIL_H
#define C1PZO_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! c1pzo from opening the wallet, thinking it was newly created, and
...
#endif // C1PZO_WALLET_WALLETUTIL_H
