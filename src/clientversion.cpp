 ...
 * for both c1pzod and c1pzo-qt, to make it harder for attackers to
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/c1pzo/bips/blob/master/bip-0014.mediawiki)
 */
