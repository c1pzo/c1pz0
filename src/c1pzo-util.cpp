...
static void SetupC1pzoUtilArgs(ArgsManager &argsman)
{
...
static int AppInitUtil(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs) || gArgs.IsArgSet("-version")) {
        ...
        std::string strUsage = PACKAGE_NAME " c1pzo-util utility version " + FormatFullVersion() + "\n";
        if (!gArgs.IsArgSet("-version")) {
            strUsage += "\n"
                "Usage:  c1pzo-util [options] [commands]  Do stuff\n";
