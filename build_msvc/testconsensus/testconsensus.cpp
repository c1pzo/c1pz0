...
// c1pzo includes.
#include <..\src\script\c1pzoconsensus.h>
...
int main()
{
    std::cout << "c1pzoconsensus version: " << c1pzoconsensus_version() << std::endl;
    ...
    auto op0Result = c1pzoconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, c1pzoconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
