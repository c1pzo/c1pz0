...
class SegWitTest(C1pzoTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older c1pzod's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let c1pzod fill it in.
