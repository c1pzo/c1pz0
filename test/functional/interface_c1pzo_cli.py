...
# The block reward of coinbaseoutput.nValue (50) PZO/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 PZO/block.
BLOCKS = 101
...
class TestC1pzoCli(C1pzoTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `c1pzo-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and c1pzo-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 PZO) to the default wallet.
            ...
            # Test c1pzo-cli -generate with -rpcwallet in multiwallet mode.
