...
class P2PPermissionsTests(C1pzoTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].c1pzoconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].c1pzoconf, 'w', encoding="utf8") as f:
            f.write(newText)
