...
By default, c1pzod will dump mempool on shutdown and
...
class MempoolPersistTest(C1pzoTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent c1pzod from writing mempool.dat to disk. Verify that `savemempool` fails")
