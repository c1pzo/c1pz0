...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the C1pzoTestFramework
    pass


class ExampleTest(C1pzoTestFramework):
    # Each functional test is a subclass of the C1pzoTestFramework class.
    ...
    def custom_method(self):
        ...
        C1pzoTestFramework class so other tests can use it."""
