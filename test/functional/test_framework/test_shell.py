...
class TestShell:
    """Wrapper Class for C1pzoTestFramework.

    The TestShell class extends the C1pzoTestFramework
    ...
    class __TestShell(C1pzoTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by C1pzoTestFramework child class.
            self.num_nodes = 1
