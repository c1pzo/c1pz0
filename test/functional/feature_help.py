...
"""Verify that starting c1pzo with -h works as expected."""

from test_framework.test_framework import C1pzoTestFramework
from test_framework.util import assert_equal

class HelpTest(C1pzoTestFramework):
    ...
    def run_test(self):
        self.log.info("Start c1pzo with -h for help text")
        ...
        self.log.info("Start c1pzo with -version for version information")
        ...
        self.log.info("Start c1pzod with -fakearg to make sure it does not start")
