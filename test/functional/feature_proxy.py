...
"""Test c1pzod with different proxy configuration.

Test plan:
- Start c1pzod's with different proxy configurations
- Use addnode to initiate connections
- Verify that proxies are connected to, and the right connection command is given
- Proxy configurations to test on c1pzod side:
...
class ProxyTest(C1pzoTestFramework):
    ...
    def node_test(self, node, proxies, auth, test_onion=True):
        ...
        # Note: c1pzod's SOCKS5 implementation only sends atyp DOMAINNAME, even if connecting directly to IPv4/IPv6
