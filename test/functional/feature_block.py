...
class FullBlockTest(C1pzoTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure c1pzod isn't accepting b26
        ...
        # Extend the b28 chain to make sure c1pzod isn't accepting b28
        ...
        # c1pzod doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the c1pzo code has custom code which does so);
