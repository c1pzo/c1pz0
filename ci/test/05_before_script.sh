...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/C1pzo
else
  DOCKER_EXEC echo \> \$HOME/.c1pzo
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/c1pzo/c1pzo/pull/18288#discussion_r433189350 for
  # details.
