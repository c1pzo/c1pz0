...
c1pzocore.org and c1pzo.org and compares them.
...
WORKINGDIR = "/tmp/c1pzo_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://c1pzocore.org"
HOST2 = "https://c1pzo.org"
VERSIONPREFIX = "c1pzo-core-"
...
def main(args):
    ...
    if not success:
        print("c1pzo.org failed to provide signature file, "
              "but c1pzocore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("c1pzo.org and c1pzocore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the C1pzo Core binary release "
