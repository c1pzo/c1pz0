...
Syntax: `getcoins.py [-h|--help] [-c|--cmd=<c1pzo-cli path>] [-f|--faucet=<faucet URL>] [-a|--addr=<signet bech32 address>] [-p|--password=<faucet password>] [--] [<c1pzo-cli args>]`

* `--cmd` lets you customize the c1pzo-cli path. By default it will look for it in the PATH
* `--faucet` lets you specify which faucet to use; the faucet is assumed to be compatible with https://github.com/kallewoof/c1pzo-faucet
* `--addr` lets you specify a Signet address; by default, the address must be a bech32 address. This and `--cmd` above complement each other (i.e. you do not need `c1pzo-cli` if you use `--addr`)
...
To mine the first block in your custom chain, you can run:
    ...
    cd src/
    CLI="./c1pzo-cli -conf=mysignet.conf"
    MINER="..contrib/signet/miner"
    GRIND="./c1pzo-util grind"
