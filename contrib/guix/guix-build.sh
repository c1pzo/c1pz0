...
# Deterministically build C1pzo Core
...
INFO: Building commit ${GIT_COMMIT:?not set} for platform triple ${HOST:?not set}:
      ...
      ...from worktree directory: '${PWD}'
          ...bind-mounted in container to: '/c1pzo'
...
EOF
        ...
        #     same exact path (e.g. mapping '/home/satoshi/c1pzo/' to
        #     '/home/satoshi/c1pzo/'). This means that the $PWD inside the
        ...
        #   --share="$PWD"=/c1pzo
        #
        #                     maps our current working directory to /c1pzo
        ...
        #     container so that we have something to build. '/c1pzo' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                        ...
                                        OUTDIR=/outdir \
                                      bash -c "cd /c1pzo && bash contrib/guix/libexec/build.sh"
    )
