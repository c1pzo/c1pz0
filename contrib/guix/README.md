# Bootstrappable C1pzo Core Builds

This directory contains the files necessary to perform bootstrappable C1pzo
Core builds.
...
- 24GB of free disk space on the partition that the C1pzo Core git repository
  resides in
...
From the top of a clean C1pzo Core repository:
...
To use dongcarl's substitute server for C1pzo Core builds after having
