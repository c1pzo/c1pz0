...
When complete, it will have produced `C1pzo-Core.dmg`.
...
apt install cpio
git clone https://github.com/c1pzo-core/apple-sdk-tools.git
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/c1pzo-core/c1pzo-detached-sigs).
