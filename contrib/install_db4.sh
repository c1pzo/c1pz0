#!/bin/sh
# Copyright (c) 2017-2019 The C1pzo Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the c1pzo repository."
  exit 1
fi
...
# See https://github.com/c1pzo/c1pzo/issues/16064
...
echo 'When compiling c1pzod, run `./configure` in the following way:'
echo
