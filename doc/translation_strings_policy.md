...
This document provides guidelines for internationalization of the C1pzo Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `c1pzo_en.ts` remains unchanged.
