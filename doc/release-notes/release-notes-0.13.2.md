C1pzo Core version 0.13.2 is now available from:

  <https://c1pzo.org/bin/c1pzo-core-0.13.2/>
...
- #8908 `4a974b2` Update c1pzo-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow c1pzo-tx to create v2 transactions (pzodrak)
