C1pzo Core version 0.9.4 is now available from:

  https://c1pzo.org/bin/0.9.4/
...
this update is incompatible with the C1pzo system and could lead to consensus
forks.

C1pzo Core released binaries from https://c1pzo.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~c1pzo/+archive/ubuntu/c1pzo
- A third-party or self-compiled C1pzo Core

upgrade to C1pzo Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
