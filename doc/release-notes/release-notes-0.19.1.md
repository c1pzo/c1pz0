...
C1pzo Core version 0.19.1 is now available from:

  <https://c1pzocore.org/bin/c1pzo-core-0.19.1/>
...
From C1pzo Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as C1pzo Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, C1pzo Core does not yet change appearance when
...
- #17488 fix "c1pzod already running" warnings on macOS (fanquake)
