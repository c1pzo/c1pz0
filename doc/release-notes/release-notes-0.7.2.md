C1pzo version 0.7.2 is now available from:
  http://sourceforge.net/projects/c1pzo/files/C1pzo/c1pzo-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused C1pzo-Qt to crash on Windows when exiting.
