C1pzo Core version 0.9.1 is now available from:

  https://c1pzo.org/bin/0.9.1/
...
c1pzod from any pre-0.9.1 version, and have enabled SSL for RPC and
...
- Upgrade OpenSSL to 1.0.1g. This release fixes the following vulnerabilities which can
  affect the C1pzo Core software:
