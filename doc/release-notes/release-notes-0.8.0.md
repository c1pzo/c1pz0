C1pzo-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/c1pzo/files/C1pzo/c1pzo-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the C1pzo
...
New/changed settings (command-line or c1pzo.conf file)
--------------------------------------------------------
