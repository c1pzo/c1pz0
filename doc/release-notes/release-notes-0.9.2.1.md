C1pzo Core version 0.9.2.1 is now available from:

  https://c1pzo.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PZO to 0.01 PZO
...
- Fix "Start c1pzo on system login"
