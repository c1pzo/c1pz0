C1pzo Core version 0.10.4 is now available from:

  <https://c1pzo.org/bin/c1pzo-core-0.10.4/>
...
- #6953 `43c2789` Split c1pzo-tx into its own package
- #6953 `dfe0d4d` Include c1pzo-tx binary on Debian/Ubuntu
