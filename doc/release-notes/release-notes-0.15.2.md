C1pzo Core version *0.15.2* is now available from:

  <https://c1pzocore.org/bin/c1pzo-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in c1pzo-tx (TheBlueMatt)
